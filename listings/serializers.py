...
class ListingSerializer(serializers.ModelSerializer):
    class Meta:
        model = Listing
        fields = ['id', 'title', 'location', 'city', 'district', 'price', 'listing_owner', 'listing_date', 'listing_update']

class CarListingSerializer(serializers.ModelSerializer):
    class Meta:
        model = CarListing
        fields = ['id', 'title', 'location', 'city', 'district', 'price', 'listing_owner', 'listing_date',
