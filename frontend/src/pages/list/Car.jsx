...
export default function CarListPage() {
  ...
  // 📄 Sayfalama State'leri (Başlangıç değerini URL'den okuyabilir)
  ...
  useEffect(() => {
    ...
    fetchListings("/search/cars/", queryParams)
      .then((data) => {
  ...
  const handlePageChange = (page) => {
    setCurrentPage(page);
    // URL'deki sayfa parametresini de senkronize et
        ...
        <div className="mb-8 flex justify-center">
          ...
          >
            <div className="relative flex items-center">
              ...
              <input
                type="text"
                placeholder="Marka, model, başlık veya kelime ile ara (Elasticsearch)..."
                value={searchInput}
